  ...
  return (
    <section className="w-full   text-white py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* Card */}
        <div className="flex flex-col md:flex-row items-center gap-8 bg-[#162d4a]/30 border border-white/10 rounded-2xl p-5 sm:p-6 lg:p-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-[12px] sm:text-[18px] text-black mb-4">
              School Director / संस्थापक एवं निदेशक
            </p>

            <p className="text-[12px] sm:text-[13px] leading-6 text-black">
            ...
            {/* Contact */}
            <div className="mt-4 text-[18px] text-[#f0ca0d] font-bold">
              Mobile: 7428044077
            </div>
